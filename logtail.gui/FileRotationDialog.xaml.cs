...
public partial class FileRotationDialog : Window
{
    public FileRotationDialogViewModel ViewModel { get; }
    public bool WasApplied { get; private set; }

    public FileRotationDialog(FileRotationDialogViewModel viewModel)
    {
        InitializeComponent();
        ViewModel = viewModel;
